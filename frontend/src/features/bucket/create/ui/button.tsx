import { CirclePlus, FolderPlus, Sparkles } from 'lucide-react'
...
export const BucketCreateButton = ({ classes }: Props) => {
  ...
  return (
    ...
    >
      ...
      <span className="flex items-center justify-center relative z-10 text-white font-medium text-base">

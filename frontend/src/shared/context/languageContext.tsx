...
const translations = {
  en: {
    ...
    'bucket_name_max_length_prefix': 'Max length: ',
    'bucket_name_max_length_suffix': ' chars (with user ID prefix).',
    'bucket_name_invalid_chars': 'Invalid characters. Use a-z, 0-9, dots (.) or hyphens (-).',
  ...
  ru: {
    ...
    'no_matching_files': 'Не найдено ни одного подходящего файла',
    ...
    'bucket_name_max_length_prefix': 'Макс. длина: ',
    'bucket_name_max_length_suffix': ' симв. (с учетом префикса ID пользователя).',
    'bucket_name_invalid_chars': 'Недопустимые символы. Используйте a-z, 0-9, точки (.) или дефисы (-).',
